...
//     0..uE2E[i].size()-1.
public func unique_edge_map<MF: Matrix, MuE: Matrix>(_ F: MF, _ E: inout Mati, _ uE: inout MuE, _ EMAP: inout Veci, _ uE2E: inout [[Int]])
where MuE.Element == Int, MF.Element == Int
{
...
public func unique_edge_map<MF: Matrix, MuE: Matrix>
(_ F: MF, _ E: inout Mati, _ uE: inout MuE, _ EMAP: inout Veci)
where MuE.Element == Int, MF.Element == Int
{
...
// }
//
func unique_edge_map<MF: Matrix, MuE: Matrix, MuEE: Matrix>
(_ F: MF, _ E: inout Mati, _ uE: inout MuE, _ EMAP: inout Veci, _ uEC: inout Veci, _ uEE: inout MuEE)
where MuE.Element == Int, MuEE.Element == Int, MF.Element == Int
{
    // Avoid using uE2E
    unique_edge_map(F, &E, &uE, &EMAP)
    var uEK = Veci()
